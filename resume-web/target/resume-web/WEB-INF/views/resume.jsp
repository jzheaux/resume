...
<body data-resume-id="${model.id}" data-page-context="${pageContext.request.contextPath}">
	<div id="content">
		<header class="profile">
			...
			<ul>
				<li><span class="email"><a data-src="${model.profile.emailRotated}" class="rotated"></a></span></li>
				<li><span class="phone"><a data-src="${model.profile.phoneRotated}" class="rotated"></a></span></li>
